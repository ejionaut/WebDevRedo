...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/styles/teacherModule.css" v=<?php echo time(); ?>>
    <link rel="stylesheet" type="text/css" href="/styles/teacherQuizzes.css" v=<?php echo time(); ?>>
