    ...
    <main>
        ...
        <div id="questionSection">
            ...
            <section-right>
                ...
                <div>
                    <button class="submitBTN" name="submitCQuestion" value="submit" onclick=<?php if (strpos($_SERVER['HTTP_REFERER'], "../includes/teacherCreateQuiz.php") || strpos($_SERVER['HTTP_REFERER'], "../includes/teacherCreateQuestions.php")) { echo "location.href='../includes/teacherModule.php'";} else { echo "history.go(-1)";}?>> Done </button>
                    <?php
                    if (strpos($_SERVER['HTTP_REFERER'], "../includes/teacherCreateQuiz.php")) {
