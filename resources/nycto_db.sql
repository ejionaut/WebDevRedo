...
--
-- Host: 127.0.0.1    Database: maindatabase2
-- ------------------------------------------------------
...
INSERT INTO `quiz_list` VALUES ('TechPres Prelims Quiz# 1','tp001a','tpqs001','listed'),('NumMeth Prelims Quiz# 1','nm001a','nmqs001','listed'),('PerDev Prelims Quiz# 1','pd001a','pdqs001','listed'),('SoftEng Prelims Quiz# 1','seqs001a','seqs001','listed'),('AppDev Prelims Quiz# 1','adqs001a','adqs001','listed'),('WebDev Prelims Quiz# 1','wdqs001a','wdqs001','unlisted'),('','','',''),('','','',''),('','','','');
...
INSERT INTO `student` VALUES (2022001,'Johnson','Dwayne'),(2022002,'Wilson','Troy'),(2022003,'Smith','Sam'),(2022004,'Williams','Robert'),(2022005,'Davis','John'),(2022006,'Garcia','Giselle'),(2022007,'Jones','Indianna'),(2022008,'Browne','Jake'),(2022009,'Moore','Mandy'),(2022010,'Miller','Gilbert');
...
INSERT INTO `student_quiz` VALUES (2022001,'tpqs001',10,1,NULL),(2022003,'tpqs001',4,2,NULL),(2022001,'pdqs001',0,7,NULL);
...
LOCK TABLES `student_quiz_details` WRITE;
/*!40000 ALTER TABLE `student_quiz_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `student_quiz_details` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-12-18 14:37:17
